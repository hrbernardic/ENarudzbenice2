    ...
    query(tableQueryRequest: TableQueryRequest): Observable<TableQueryResponseOfAdresaBrowse | null> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<TableQueryResponseOfAdresaBrowse | null>><any>_observableThrow(response_);
        }));
    }
    ...
    getAll(): Observable<Adresa[] | null> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<Adresa[] | null>><any>_observableThrow(response_);
        }));
    }
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                ...
                for (let item of resultData200)
                    result200.push(Adresa.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
    ...
    login(command: UserLoginCommand): Observable<LoginDto | null> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<LoginDto | null>><any>_observableThrow(response_);
        }));
    }
    ...
    query(tableQueryRequest: TableQueryRequest): Observable<TableQueryResponseOfDjelatnostBrowse | null> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<TableQueryResponseOfDjelatnostBrowse | null>><any>_observableThrow(response_);
        }));
    }
    ...
    getAll(): Observable<Djelatnost[] | null> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<Djelatnost[] | null>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<Djelatnost[] | null> {
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Djelatnost.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        if (data) {
            ...
            if (data["results"] && data["results"].constructor === Array) {
                ...
                for (let item of data["results"])
                    this.results.push(AdresaBrowse.fromJS(item));
            }
        }
    }
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["results"] && data["results"].constructor === Array) {
                this.results = [];
                for (let item of data["results"])
                    this.results.push(DjelatnostBrowse.fromJS(item));
            }
        }
    }
